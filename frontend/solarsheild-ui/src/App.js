        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
          ...
          <div style={{ background: "#1e293b", borderRadius: "12px", padding: "24px", border: "1px solid #334155" }}>
            ...
            <input
              ...
              style={{ width: "100%", padding: "10px", marginBottom: "12px", borderRadius: "8px", border: "1px solid #334155", background: "#0f172a", color: "white", boxSizing: "border-box" }}
            />
            <input
            ...
            <input
              type="datetime-local"
              value={alertForm.flight_time}
              onChange={e => setAlertForm({...alertForm, flight_time: e.target.value})}
              style={{ width: "100%", padding: "10px", marginBottom: "16px", borderRadius: "8px", border: "1px solid #334155", background: "#0f172a", color: "white", boxSizing: "border-box" }}
            />
            <button
              onClick={handleAlertSubmit}
              style={{ width: "100%", padding: "12px", borderRadius: "8px", border: "none", background: "#38bdf8", color: "#0f172a", fontWeight: "bold", cursor: "pointer", fontSize: "14px" }}
            >
